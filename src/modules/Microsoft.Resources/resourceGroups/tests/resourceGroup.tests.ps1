Describe "Resource Group" -Tag resourceGroup {
    Context "Validate Resource Group" {
        It "Should be created successfully" {
            ...
            az deployment sub create --template-file .\src\modules\Microsoft.Resources\resourceGroups\main.bicep -l westeurope --parameters .\src\modules\Microsoft.Resources\resourceGroups\examples\resourceGroup.parameters.json
